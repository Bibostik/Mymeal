...
//             className="bg-white p-4 shadow-md rounded-lg hover:shadow-lg hover:shadow-xl transition-shadow"
//           >
//             <Link href={`/foodSinglePage/${food.slug?.current}`} passHref legacyBehavior>
//               <a className="block">
//                 <img
//                   src={`${food.image}`}
//                   alt={food.name}
...
//         <p className="text-gray-600">Total: £{selectedItems.reduce((total, item) => total + item.price, 0)}</p>
//       </div>
//     </div>
//   );
// };
